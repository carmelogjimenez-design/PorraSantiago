      ...
      <div className="p-3.5">
        ...
        {hasScorers && (
          <div className="mt-2.5 border-t border-[var(--border)] pt-2 text-[12px] leading-snug">
            {scH && <div className="flex gap-1.5"><span>\u26bd</span><span className="font-semibold">{m.homeName}:</span> <span className="text-[var(--text-dim)]">{scH}</span></div>}
            {scA && <div className="mt-0.5 flex gap-1.5"><span>\u26bd</span><span className="font-semibold">{m.awayName}:</span> <span className="text-[var(--text-dim)]">{scA}</span></div>}
          </div>
        )}
      </div>
